...
def cal_values(binning_parameters, all_parameters, lmin, wmin):
    '''
    binning_parameters=['a0', 'ags', 'at', 'cit', 'eta0', 'k2', 'k2we', 'keta', 'kt1', 'kt2', 'ku0', 'ku0we', 'kvth0', 'kvth0we', 'nfactor', 'pclm', 'pdiblc2', 'tvoff', 'u0', 'ua', 'ua1', 'ub', 'ub1', 'uc', 'uc1', 'ud', 'ute', 'voff', 'vsat', 'vth0']
...
for par in binning_parameters:
    ...
    for key, value in all_parameters.items():
        ...
        if l_par1 == key:
            print(type(value))
            print(type(l))
            par_val_l = float(value) / l
            print(par_val_l)

        if w_par1 == key:
            print(type(value))
            print(type(l))
            par_val_w = float(value) / w
            print("w-type")
            print(par_val_w)
